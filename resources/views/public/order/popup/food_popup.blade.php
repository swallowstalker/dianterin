...
//        });
//
//        // register triggers for magnific popup insufficient balance
//        $(".insufficient-popup-button").magnificPopup({
//            mainClass: 'mfp-fade',
//            callbacks: {
//                beforeOpen: function() {
//                    $("#insufficient-popup #validation-message").html(validationMessage);
//                }
//            }
//        });
//
//        // register triggers for magnific popup timeout
//        $(".timeout-popup-button").magnificPopup({
//            mainClass: 'mfp-fade',
//            callbacks: {
//            }
//        });
...
//
//            $(".insufficient-popup-button").click();
//
